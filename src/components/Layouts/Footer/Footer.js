			...
			<div className="containerFooter">
						<div className="footer-widget">
							...
							<div className="footer-widget-text">
								<p>Encuentra tu pasión en el ejercicio y despierta la mejor versión de ti mismo. ¡No hay límites para lo que puedes lograr cuando te comprometes y te entregas por completo!</p>
							</div>
						...
						<div className="footer-widget-quote-contact">
							<div className="widget-title">
								<h2>Contacto</h2>
							</div>
							<ul>
							...
							<div className="coppy-right-text">
								<p>© 2023.
									<span className="headline-color">GYMQU</span> Armenia</p>
							</div>
		</div>
	);
};
